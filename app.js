...
function mainBracketSvg() {
  ...
  const m = [
    ...
    { x: x2, y: 45,  a: "Mario Camenzind (1. A)",  b: "Marcel Gehringer", score: "6:4 6:3" },

    { x: x1, y: 210, a: "-",                b: "-", score: "" },
    { x: x1, y: 300, a: "Marco Camenzind (2. D)", b: "Philip Camenzind (3. C)", score: "6:3 6:4" },
    { x: x2, y: 255, a: "Julian Bolfing (1. B)",  b: "Marco Camenzind", score: "6:1 6:2" },

    { x: x1, y: 420, a: "-",                b: "-", score: "" },
    { x: x1, y: 510, a: "Christian Schnyder (2. A)", b: "Marco Appert (3. B)", score: "6:0 6:0" },
    { x: x2, y: 465, a: "Oliver Bolfing (1. C)",  b: "Christian Schnyder", score: "2:6 3:6" },

    { x: x1, y: 630, a: "-",                b: "-", score: "" },
    { x: x1, y: 720, a: "Pascal Steiner (2. B)", b: "Sabine Allemann (3. A)", score: "6:0 6:2" },
    { x: x2, y: 675, a: "Urs Huber (1. D)",  b: "Pascal Steiner", score: "4:6 2:6" },

    { x: x3, y: 150, a: "Mario Camenzind", b: "Julian Bolfing", score: "" },
    { x: x3, y: 570, a: "Christian Schnyder", b: "Pascal Steiner", score: "" },
...
function placementBracketSvg() {
  ...
  const m = [
    ...
    { x: x2, y: 85,  a: "Maximilian Weber", b: "Sandro Schuler", score: "6:3 6:4" },
    { x: x2, y: 445, a: "Alan Tarantino", b: "Enzo Nigg", score: "0:6 1:6" },

    { x: x3, y: 265, a: "Maximilian Weber", b: "Enzo Nigg", score: "" }
  ];
